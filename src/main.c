...
static void	check_args(int ac, char **av, t_parser *parser)
{
	if (ac != 2)
	{
		write(2, "Error\nUsage: ./cub3d <map.cub>\n", 31);
...
static int	store_identifier(char *line, t_map_data *map_data, t_parser *parser)
{
...
static void	read_file(t_main *main)
{
	char	*line;
	int		headers_found;
